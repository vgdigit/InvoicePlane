...
class Mdl_Setup extends CI_Model
{
    ...
    private function install_default_settings()
    {
        ...
        $default_settings = array(
            ...
            'pdf_invoice_template' => 'CivilTec',
            'pdf_invoice_template_paid' => 'CivilTec - paid',
            'pdf_invoice_template_overdue' => 'CivilTec - overdue',
            'pdf_quote_template' => 'CivilTec',
            'public_invoice_template' => 'CivilTec_Web',
            'public_quote_template' => 'CivilTec_Web',
            'disable_sidebar' => 1,
        );
